  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-center justify-center p-6">
      <div className="relative w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl p-6">
        ...
        {/* Header */}
        <h3 className="text-2xl font-bold text-white mb-6">Log Meal</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Field>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-purple-600 resize-none"
              disabled={submitting}
            />
          </Field>
